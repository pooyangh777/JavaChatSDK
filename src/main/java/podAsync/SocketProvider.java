...
import static podAsync.model.AsyncMessageType.DeviceRegister;
import static podAsync.model.AsyncMessageType.ServerRegister;
...
public class SocketProvider implements AsyncProvider {
    ...
    private void registerDevice() {
        ...
        String asyncString = getMessageWrapper(DeviceRegister, gson.toJson(register));
        send(asyncString);
    }

    private void registerServer() {
        RegisterServer register = new RegisterServer(config.getServerName());
        String asyncString = getMessageWrapper(ServerRegister, gson.toJson(register));
        send(asyncString);
    }
