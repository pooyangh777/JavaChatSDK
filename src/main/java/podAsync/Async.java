...
import static podAsync.model.AsyncMessageType.Ack;
import static podAsync.model.AsyncState.AsyncReady;
    ...
    private void handleOnMessageAckNeeded(ClientMessage clientMessage) {
        try {
            if (provider != null) {
                ...
                String jsonSenderAckNeededWrapper = getMessageWrapper(gson, jsonSenderAckNeeded, Ack);
